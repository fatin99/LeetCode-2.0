...
class Vehicle(metaclass=ABCMeta):
    def __init__(self, license_number: str, vehicle_type: VehicleType, assigned_ticket: ParkingTicket = None):
...
class ParkingSpot(metaclass=ABCMeta):
    def __init__(self, lot_number: str, spot_type: ParkingSpotType, curr_vehicle: Vehicle = None):
    ...
    def fits(self, new_vehicle: Vehicle) -> bool:
        ...
        return self.__spot_type in self._ALLOWED_SPOTS.get(new_vehicle.vehicle_type, set())
    ...
    def is_full(self, new_vehicle: Vehicle):
        for floor, parking_spots in self.__floors:
            for parking_spot in parking_spots:
                if (parking_spot.curr_vehicle == None 
                    and parking_spot.fits(new_vehicle)):
                    return False
        return True
