...
class Solution:
    ...
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        for end in range(len(s)):
            ...
            while start < end:
                if (
                    curr_window - max_char <= k
                ):  # there exists a replacement in less than k steps that satisfies substring start to end
                    break
                # curr_str = s[start:end+1]
    ...
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        for end in range(len(s)):
            ...
            max_char = max(
                char_count.values()
            )  # this is O(26) because s consists of only uppercase English letters.
            curr_window = end - start + 1
